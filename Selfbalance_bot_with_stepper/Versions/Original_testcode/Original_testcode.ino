...
#include <i2c_t3.h>                                          //Include the Wire.h library so we can communicate with the gyro
#include <TimerOne.h>

int gyro_address = 0x68;                                     //MPU-6050 I2C address (0x68 or 0x69)
int acc_calibration_value = -65519;                            //Enter the accelerometer calibration value
...
void setup(){
  ...
  Wire.begin (I2C_MASTER,0x00,I2C_PINS_18_19,I2C_PULLUP_EXT,400000); //Set the SDA0/SCL0 I2C at 400kHz

  Timer1.initialize(20); //Begin using the timer 1. This function must be called first. "(microseconds)" is the period of time the timer takes.
  Timer1.attachInterrupt(balancer);
  ...
  pinMode(29, OUTPUT);                                                       //Configure digital poort 4 as output
  pinMode(30, OUTPUT);                                                       //Configure digital poort 5 as output
